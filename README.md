...
🔨 Forja v0.9.1 — Escribí 'salir' para terminar
> variable x = 10
> x = x + 5
> escribir(x)
15
...
# Compilar a ejecutable autónomo (autocontenido, sin transpilación)
PS C:\forja> forja compilar ejemplos/gui.fa -o miapp.exe
```
